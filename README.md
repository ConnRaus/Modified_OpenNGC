...
This is a modified version of the OpenNGC project, intended for my personal use with developing StarTeller. I have added/modified object names to the NGC.csv and addendum.csv files, and removed all other files I don't need. Huge thanks to the original authors of OpenNGC for creating such a great database!

© Original OpenNGC authors
